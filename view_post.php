...
<!-- Centre Container -->
<div style="background:transparent url('imgs/bb8_post.jpg') no-repeat center center /cover" class="col-sm-10 img-text-left main_container"> 
    <br><br>
    <div class="text-center"><button class="btn btn default rebellion"><a href="index.php">Back to Home</a></button></div>   
